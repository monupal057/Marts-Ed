...
import { addUser, removeUser } from "../redux/heroSlice";
...
//   return (
//     <div className="min-h-screen flex flex-col items-center justify-center gap-10 py-10 px-4 sm:px-6 lg:px-8">
//       <div className="w-full flex flex-col items-center justify-center gap-6">
//         <button
//           onClick={handleGoogleLogin}
//           className="w-full md:w-80 h-12 md:h-14 text-base tracking-wide border border-gray-400 rounded-md flex items-center justify-center gap-2 hover:border-blue-600 cursor-pointer duration-300"
//         >
//           <img className="w-8" src={googleLogo} alt="googleLogo" />
//           <span className="text-sm text-gray-900">Sign in with Google</span>
//         </button>
...
//           className="w-full md:w-80 bg-black text-white text-base py-3 md:py-4 px-8 tracking-wide rounded-md hover:bg-gray-800 duration-300"
//         >
//           Sign Out
//         </button>
//       </div>
